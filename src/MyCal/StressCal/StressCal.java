    ...
    public void operateButton(ActionEvent evt){
       ...
       //Getting stress...
        if (buttonText.equals("Stress =")){
           ...
           BigDecimal ans1= num1.divide(num2,4, RoundingMode.HALF_UP); // Getting answer ....
            AnsA.setText(String.valueOf(ans1));// Setting text with answer....
        }
        ...
        //Getting force....
            ...
            BigDecimal ans1= num1.multiply(num2); // Getting answer ....
            AnsB.setText(String.valueOf(ans1));// Setting text with answer....
        }
        ...
        //Getting area.....
            ...
            BigDecimal ans1= num1.divide(num2,4, RoundingMode.HALF_UP); // Getting answer ....
            AnsC.setText(String.valueOf(ans1));  // Setting text with answer....
        }
