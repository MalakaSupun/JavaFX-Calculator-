...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
       ...
       try {
           ...
           primaryStage.getIcons().add(icon);                                                // Setting up the icon for app ... 
    ...
    public void CreateHookesLaw(){
        ...
        EngStage.setAlwaysOnTop(true);                                                    // set always on top ....................
        EngStage.setResizable(false);                                                     // set window size as permanent..........
    ...
    public void CreateStressCal(){
        ...
        Image icon = new Image(getClass().getResourceAsStream("icon/Calculator.png"));      // Icon location .........................
        AboutStage.getIcons().add(icon);                                                    // Set-up the icon .......................  
